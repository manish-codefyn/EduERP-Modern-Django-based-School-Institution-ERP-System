...
# -------------------- Student Portal Essential Models --------------------

class StudentPortalSettings(models.Model):
    """Student portal preferences and settings"""
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    institution = models.ForeignKey(
        "organization.Institution",
        on_delete=models.CASCADE,
        related_name="student_portal_settings",
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="created_student_portal_settings",
    ...
    class Meta:
        ...
        verbose_name = _("Student Portal Settings")
        verbose_name_plural = _("Student Portal Settings")

    def __str__(self):
        return f"Portal Settings - {self.student} ({self.institution})"


class StudentDashboard(models.Model):
    """Student dashboard tracking and preferences"""
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    institution = models.ForeignKey(
        "organization.Institution",
        on_delete=models.CASCADE,
        related_name="student_dashboards",
        verbose_name=_("Institution")
    )
    student = models.OneToOneField(
        Student,
    ...
    widgets_config = models.JSONField(
        default=dict,
        verbose_name=_("Widgets Configuration")
    )
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="created_student_dashboards",
        verbose_name=_("Created By")
    )
    created_at = models.DateTimeField(auto_now_add=True, verbose_name=_("Created At"))
    ...
    class Meta:
        ...
        verbose_name = _("Student Dashboard")
        verbose_name_plural = _("Student Dashboards")

    def __str__(self):
        return f"Dashboard - {self.student} ({self.institution})"


class StudentPortalNotification(models.Model):
    """Portal-specific notifications for students"""
    ...
    institution = models.ForeignKey(
        "organization.Institution",
        on_delete=models.CASCADE,
        related_name="student_portal_notifications",
        verbose_name=_("Institution")
    )
    student = models.ForeignKey(
        Student,
    ...
    related_model = models.CharField(max_length=50, blank=True, verbose_name=_("Related Model"))
    related_id = models.UUIDField(null=True, blank=True, verbose_name=_("Related ID"))
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="created_student_portal_notifications",
        verbose_name=_("Created By")
    )
    created_at = models.DateTimeField(auto_now_add=True, verbose_name=_("Created At"))
    ...
    class Meta:
        ...
        ordering = ["-created_at"]
        verbose_name = _("Student Portal Notification")
        verbose_name_plural = _("Student Portal Notifications")
        indexes = [
    ...
    def __str__(self):
        return f"{self.title} - {self.student} ({self.institution})"
