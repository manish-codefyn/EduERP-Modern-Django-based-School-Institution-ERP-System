...
class TeacherManagementRequiredMixin(ManagementRequiredMixin):
    entity_name = "teacher"
    allowed_roles = [
        User.Role.SUPERADMIN,
        User.Role.INSTITUTION_ADMIN,
...
class StaffManagementRequiredMixin(ManagementRequiredMixin):
    entity_name = "staff"
    allowed_roles = [
        User.Role.SUPERADMIN,
        User.Role.INSTITUTION_ADMIN,
...
class StudentManagementRequiredMixin(ManagementRequiredMixin):
    entity_name = "student"
    allowed_roles = [
        User.Role.SUPERADMIN,
        User.Role.INSTITUTION_ADMIN,
...
class HRManagementRequiredMixin(ManagementRequiredMixin):
...
class LibraryManagerRequiredMixin(RoleRequiredMixin):
