...
class InstitutionComplianceListView(LoginRequiredMixin, StaffManagementRequiredMixin, ListView):
...
class InstitutionComplianceCreateView(LoginRequiredMixin, StaffManagementRequiredMixin, CreateView):
    model = InstitutionCompliance
...
class InstitutionComplianceUpdateView(LoginRequiredMixin, StaffManagementRequiredMixin, UpdateView):
    model = InstitutionCompliance
    form_class = InstitutionComplianceForm
    template_name = 'organization/compliance/compliance_form.html'
...
class InstitutionComplianceDetailView(LoginRequiredMixin, StaffManagementRequiredMixin, DetailView):
    model = InstitutionCompliance
...
class InstitutionComplianceDeleteView(LoginRequiredMixin, StaffManagementRequiredMixin, DeleteView):
    model = InstitutionCompliance
...
class InstitutionComplianceExportView(LoginRequiredMixin, StaffManagementRequiredMixin, ListView):
    model = InstitutionCompliance
